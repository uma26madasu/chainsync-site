...
ChainSync - Every second counts when protecting our environment
    ...
    function generateResponse(message) {
      ...
      const phraseMatches = [
        ...
        { phrases: ['what is actually built', 'whats real', 'actual status', 'honest status', 'really built'], response: responses.realStatus },
        { phrases: ['environmental impact', 'save planet', 'environmental protection'], response: responses.environmentalImpact },
        { phrases: ['epa compliance', 'compliance details', 'regulatory requirements'], response: responses.complianceDetails },
