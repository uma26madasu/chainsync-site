          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <Card className="p-8 bg-white border border-border h-full">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  Facilities teams managing HVAC failures, hazmat incidents, and power events across complex, multi-department environments. Working Bosch Climatic BMS adapter already built.
                </p>
                <ul className="space-y-1 text-sm text-muted-foreground">
                  <li>✓ Bosch Climatic BMS adapter (built and tested)</li>
