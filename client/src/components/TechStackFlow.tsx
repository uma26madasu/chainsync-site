...
const STACKS = [
  ...
  },
  {
    ...
    tech: ["17 Python Agents", "FastAPI", "AI Engine", "HTTP Webhooks"],
    detail: "Specialized intelligence layer. 17 Python agents each run as an independent FastAPI service and communicate via HTTP webhooks. AI Engine powers the reasoning agent for context-aware analysis.",
    items: [
      ...
      { name: "AI Reasoning Engine", desc: "Reasoning and decision support" },
